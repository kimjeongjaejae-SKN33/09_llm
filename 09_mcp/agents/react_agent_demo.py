...
async def build_agent():
    ...
    return create_agent(
        ...
        system_prompt = (
            ...
            "현재 날씨 조회는 get_currnet_weather_via_mcp를 사용한다."
...
# LLM에게 MCP 호출하는 것을 도구로 등록해서
# LLM이 사용자 질문에 맞춰 알아서 MCP를 호출할 수 있게 함.
# (기존 -> 사용자가 MCP 이름을 명시해야함.)